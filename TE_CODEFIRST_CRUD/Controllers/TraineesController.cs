...
namespace TE_CODEFIRST_CRUD.Controllers
{
    public class TraineesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("TraineeID,TraineeName,TraineeAge,TraineeMobile,TraineeEmail,TPassword,TConfirmPassword")] Trainee trainee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("TraineeID,TraineeName,TraineeAge,TraineeMobile,TraineeEmail,TPassword,TConfirmPassword")] Trainee trainee)
        {
